...
// NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "ShowTracker" in code, svc and config file together.
public class ShowInfoService : IShowInfoService
{
    ...
    public List<ShowInfo> GetShowByArtist(string ArtistShowName)
    {
        ...
        foreach (var sa in show)
        {
            ...
            info.ArtistName = ArtistShowName;
            artshow.Add(info);
        }
        return artshow;
    }
